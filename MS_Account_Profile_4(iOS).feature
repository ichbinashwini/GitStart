...
Feature: MS_Account_Profile
  ...
  @High
  @Unit_Test
  Scenario Outline: MS_AP Password field validation (iOS only)
    When I tap on the "Password" option
    ...
    When I tap on "OK" button on the alert
    Then I should verify "Password" title is displayed on the screen
    ...
    | eko12345         |  test345      | test456              | Passwords must be at least 8 characters. |

  @BDDTEST-QA-2525
  @Clinic_Automation
  @High
  @Unit_Test
  Scenario Outline: MS_AP Name and Email Validation (iOS only)
    When I tap on the "Name and Email" option
    ...
    |            | plname    | testingekohealth@gmail.com | eko12345 | Please enter your first name                             |
    | pfname     |           | testingekohealth@gmail.com | eko12345 | Please enter your last name                             |
    | pfname     | plname    |                            | eko12345 | Please enter your email address                          |
    | pfname     | plname    | test                       | eko12345 | Please enter a valid email address                       |
